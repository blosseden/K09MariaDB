...
<body>
<!-- 
세션 유지시간은 web.xml에서 바꿀 수 있다.
 -->
 
<h2>세션 유지시간 session내장객체로 설정하기</h2>
<%
/*
web.xml에서 설정할때는 분단위로 설정하고, 만약 설정값이 없을때는 30분(1800초)로 설정된다.
웹어플리케이션이 실행될때는  web.xml의 설정값이 먼저 실행되고, 아래 JSP코드가 실행되게된다.
*/
//내장객체를 사용할 때는 초단위로 사용한다.
